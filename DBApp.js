...
function showSchemaInfo(sn) {
    ...
    document.getElementById('content').innerHTML = "<button onclick=\"showSchemaInfo(" + sn + ")\">Refresh</button><table class='sortable'><thead><th>Catalogue</th><th>Schema</th><th>Charset</th><th>Collation</th><th>Size (MB)</th><th>Tables</th></tr><tbody><tr><td>" + schemaData[sn].catalog + "</td><td>" + schemaData[sn].schema + "</td><td>" + schemaData[sn].charset + "</td><td>" + schemaData[sn].collation + "</td><td>" + parseFloat(schemaData[sn].mb).toLocaleString() + "</td><td>" + parseInt(schemaData[sn].tables).toLocaleString() + "</td></tr></tbody></table>";
    wvtables(
